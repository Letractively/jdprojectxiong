			...
			<h:form>
				<a4j:region id="customerRegisterRegion" renderRegionOnly="false" selfRendered="true">
					...
					<h:panelGrid columns="3" columnClasses="common-panel-grid-one,common-panel-grid-two,common-panel-grid-three" rowClasses="common-panel-grid-row">
						...
						<h:outputLabel value="请设置密码：" for="userPassword"></h:outputLabel><h:inputText id="userPassword" value="#{registPage.userPassword}"><f:validator validatorId="PasswordValidator"/></h:inputText><h:message for="userPassword" />
						<h:outputLabel value="请确认密码：" for="verifyPassword"></h:outputLabel><h:inputText id="verifyPassword" value="#{registPage.verifyPassword}"><f:validator validatorId="PasswordValidator"/></h:inputText><h:message for="verifyPassword" />
						...
						<h:outputText value=""></h:outputText><h:panelGroup><h:commandLink value="填写完毕，注册" styleClass="ButtonYellow"></h:commandLink><h:commandLink type="reset" value="重置" styleClass="ButtonDefault"></h:commandLink></h:panelGroup><h:outputText value=""></h:outputText>
					</h:panelGrid>
					</rich:panel>
