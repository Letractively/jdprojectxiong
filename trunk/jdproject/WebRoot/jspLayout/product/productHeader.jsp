			...
			<tr>
				...
				<div id="dynamicmenu-hdrCtr" class="hdrCtr">
					<table class="logobar" border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<td class="mr" width="2%" valign="bottom"><span class="greeting"><!-- BEGIN: GREETING:SIGNEDOUT -->欢迎光临! 请<a href="${facesContext.externalContext.requestContextPath}/jspLayout/common/customerLogin.jsf" tabindex="-1" rel="nofollow">登录</a> 或 <a href="${facesContext.externalContext.requestContextPath}/jspLayout/common/customerRegister.jsf" tabindex="-1" id="registerLink" rel="nofollow">注册</a>.<!-- END: GREETING:SIGNEDOUT --><span id="bta"></span></span></td>
