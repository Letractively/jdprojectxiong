...
<h:form id="productHeaderMainform"> 
	<a4j:region id="productHeaderRegion" renderRegionOnly="false" selfRendered="true">
		...
		<div class="tabs">
		<ul>
		<li class="selected"><a href="http://www.superpages.com/"><span>首页</span></a></li>
		<li><script type="text/javascript">displayResLink();</script><a onclick="omniTrackHeaderTabs('People');" href="http://find.person.superpages.com/" rel="nofollow"><span>产品浏览</span></a></li>
		<li><script type="text/javascript">displayMapLink();</script><a onclick="omniTrackHeaderTabs('Map');" href="http://yellowpages.superpages.com/mapbasedsearch/mapsearch.jsp?L=" rel="nofollow"><span>管理中心</span></a></li>
		<li><a onclick="omniTrackHeaderTabs('Cars');" href="http://cars.superpages.com/#sptab" rel="nofollow"><span>资讯</span></a></li>
		</ul>
		</div>
