...
<html>
    ...
    <body>
    	<ui:composition template="../productTemplate.jsp">
    		<ui:define id="toasterLeft" name="left">
			...
			<ui:define id="toasterContent" name="content">
    			...
    			<rich:panelBar id="toasterpb" styleClass="panel-none-border" headerClass="panel-header-none-border" style="width:#{msgs['template.product.content.widthpx']};border-style:none;" contentStyle="panel-documents-none-border">
    				<rich:panelBarItem id="toasterPbi" headerClass="navigation-product-top-panel-bar-item-header">
    				<f:facet name="label">
    					<h:panelGroup>
    						<h:outputText value="商品筛选" styleClass="navigation-product-top-panel-bar-item-header-label"></h:outputText>
    					</h:panelGroup>
    				</f:facet>
						<ui:include id="phoneinp12" src="./SubToaster/navigationTopToaster.jsp">
							<ui:param name="brands" value="#{navigationToaster.brandCodeItems}" />
							<ui:param name="priceRangeList" value="#{navigationToaster.priceRangeList}"/>
							<ui:param name="typeItems" value="#{navigationToaster.typeItems}"/>
						</ui:include>
					</rich:panelBarItem>
				</rich:panelBar>
				</h:form>
    			...
    			<a4j:region id="toasterContentRegionStyle" renderRegionOnly="false" selfRendered="true">
    				<h:form id="toasterContentRegionStyleForm">
    					<rich:panel id="toasterContentRegionStyleFormPanel" styleClass="operate_title">
    						<h:panelGrid columns="2" style="width:80%;">
								...
								<a4j:commandLink id="imgbutton" reRender="toasterContentRegionStyleFormPanel,productList">
									<h:graphicImage value="/css/images/i_img#{listToasterProduct.styleImg}.gif" style="border:0;width:18px;height:18px;vertical-align: middle;">
									</h:graphicImage>
									<a4j:actionparam name="styleImg" value="_on" assignTo="#{listToasterProduct.styleImg}"></a4j:actionparam>
									<a4j:actionparam name="styleImgFont" value="" assignTo="#{listToasterProduct.styleImgFont}"></a4j:actionparam>
									<a4j:actionparam name="styleFont" value="" assignTo="#{listToasterProduct.styleFont}"></a4j:actionparam>
								</a4j:commandLink>
								<a4j:commandLink id="imgfontbutton" reRender="toasterContentRegionStyleFormPanel,productList">
									<h:graphicImage value="/css/images/i_imgfont#{listToasterProduct.styleImgFont}.gif" style="border:0;width:18px;height:18px;vertical-align: middle;">
									</h:graphicImage>
									<a4j:actionparam name="styleImg" value="" assignTo="#{listToasterProduct.styleImg}"></a4j:actionparam>
									<a4j:actionparam name="styleImgFont" value="_on" assignTo="#{listToasterProduct.styleImgFont}"></a4j:actionparam>
									<a4j:actionparam name="styleFont" value="" assignTo="#{listToasterProduct.styleFont}"></a4j:actionparam>
								</a4j:commandLink>
								<a4j:commandLink id="fontbutton" reRender="toasterContentRegionStyleFormPanel,productList">
									<h:graphicImage value="/css/images/i_font#{listToasterProduct.styleFont}.gif" style="border:0;width:18px;height:18px;vertical-align: middle;">
									</h:graphicImage>
									<a4j:actionparam name="styleImg" value="" assignTo="#{listToasterProduct.styleImg}"></a4j:actionparam>
									<a4j:actionparam name="styleImgFont" value="" assignTo="#{listToasterProduct.styleImgFont}"></a4j:actionparam>
									<a4j:actionparam name="styleFont" value="_on" assignTo="#{listToasterProduct.styleFont}"></a4j:actionparam>
								</a4j:commandLink>
							</h:panelGroup>
							<h:panelGroup>
									...
									<h:graphicImage value="/css/images/icons/list.gif" style="border:0;vertical-align: middle;"></h:graphicImage>
									<h:outputText value="        "></h:outputText>
									<a4j:commandLink id="number15button" reRender="toasterContentRegionStyleFormPanel,productList">
										<h:graphicImage value="/css/images/number15#{listToasterProduct.number10}.gif" style="border:0;width:20px;height:17px;vertical-align: middle;">
										</h:graphicImage>
										<a4j:actionparam name="number10" value="_on" assignTo="#{listToasterProduct.number10}"></a4j:actionparam>
									...
									<a4j:commandLink id="number30button" reRender="toasterContentRegionStyleFormPanel,productList">
										...
										<a4j:actionparam name="number10" value="" assignTo="#{listToasterProduct.number10}"></a4j:actionparam>
                ...
                <f:facet name="header">
                	<h:outputText value="共:#{listToasterProduct.dataModel.rowCount}件商品" rendered="#{listToasterProduct.dataModel.rowCount>0}"></h:outputText>
                 	...
                 	<f:facet name="footer">
                 	<h:panelGroup>
                 		<rich:datascroller for="productListImg" id="dcFooterProductList" page="#{listToasterProduct.scrollerPage}" pageIndexVar="currentPage" pagesVar="totalPages" maxPages="10" rendered="#{listToasterProduct.dataModel.rowCount>0}" style="width:483px;align:center">
                ...
                <f:facet name="header">
                	<h:outputText value="共:#{listToasterProduct.dataModel.rowCount}件商品" rendered="#{listToasterProduct.dataModel.rowCount>0}"></h:outputText>
                 	...
                 	<f:facet name="footer">
                 	<h:panelGroup>
                 		<rich:datascroller for="productListImgFont" id="imgFontFooterProductList" page="#{listToasterProduct.scrollerPage}" pageIndexVar="currentPage" pagesVar="totalPages" maxPages="10" rendered="#{listToasterProduct.dataModel.rowCount>0}" style="width:483px;align:center">
                 		<f:facet name="controlSeparator">
                 		</f:facet>
                 		<f:facet name="first">
                 		</f:facet>
                ...
                <f:facet name="header">
                	<h:outputText value="共:#{listToasterProduct.dataModel.rowCount}件商品" rendered="#{listToasterProduct.dataModel.rowCount>0}"></h:outputText>
                 	...
                 	<f:facet name="footer">
                 	<h:panelGroup>
                 		<rich:datascroller for="productListFont" id="FontFooterProductList" page="#{listToasterProduct.scrollerPage}" pageIndexVar="currentPage" pagesVar="totalPages" maxPages="10" rendered="#{listToasterProduct.dataModel.rowCount>0}" style="width:483px;align:center">
                 		<f:facet name="controlSeparator">
                 		</f:facet>
                 		<f:facet name="first">
                 		</f:facet>
    		...
    		<ui:define id="toasterRight" name="right">
    			<h:outputText value=""></h:outputText>
    		</ui:define>
    	</ui:composition>
    </body>
