...
<html>
    ...
    <body>
    	<ui:composition template="../productTemplate.jsp">
    		<ui:define id="electronicOvenLeft" name="left">
			...
			<ui:define id="electronicOvenContent" name="content">
    			...
    			<rich:panelBar id="electronicOvenpb" styleClass="panel-none-border" headerClass="panel-header-none-border" style="width:#{msgs['template.product.content.widthpx']};border-style:none;" contentStyle="panel-documents-none-border">
    			...
    			<a4j:region id="electronicOvenContentRegionStyle" renderRegionOnly="false" selfRendered="true">
    				<h:form id="electronicOvenContentRegionStyleForm">
    					<rich:panel id="electronicOvenContentRegionStyleFormPanel" styleClass="operate-show-style">
							...
							<h:panelGroup>
									...
									<a4j:commandLink id="number15button" reRender="electronicOvenContentRegionStyleFormPanel,productList">
										...
										<a4j:actionparam name="numberOnePage" value="15" assignTo="#{listElectronicOvenProduct.numberOnePage}"></a4j:actionparam>
								    </a4j:commandLink>
									<a4j:commandLink id="number30button" reRender="electronicOvenContentRegionStyleFormPanel,productList">
										...
										<a4j:actionparam name="number40" value="" assignTo="#{listElectronicOvenProduct.number40}"></a4j:actionparam>
										<a4j:actionparam name="number100" value="" assignTo="#{listElectronicOvenProduct.number100}"></a4j:actionparam>
										<a4j:actionparam name="numberOnePage" value="30" assignTo="#{listElectronicOvenProduct.numberOnePage}"></a4j:actionparam>
								    </a4j:commandLink>
									<a4j:commandLink id="number60button" reRender="electronicOvenContentRegionStyleFormPanel,productList">
										...
										<a4j:actionparam name="number100" value="" assignTo="#{listElectronicOvenProduct.number100}"></a4j:actionparam>
										<a4j:actionparam name="numberOnePage" value="45" assignTo="#{listElectronicOvenProduct.numberOnePage}"></a4j:actionparam>
								    </a4j:commandLink>
									<a4j:commandLink id="number90button" reRender="electronicOvenContentRegionStyleFormPanel,productList">
										...
										<a4j:actionparam name="numberOnePage" value="90" assignTo="#{listElectronicOvenProduct.numberOnePage}"></a4j:actionparam>
								    </a4j:commandLink>
