...
public class ExistKitchenApplianceCoffeeMachineProductBrandBean {
	private static SelectItem[] brandCodeItems = {
		...
		new SelectItem(EjdConstants.BRAND_DEERDQ_NAME,EjdConstants.BRAND_DEERDQ_LABEL),
	};
	...
	public static void setBrandCodeItems(SelectItem[] brandCodeItems) {
		ExistKitchenApplianceCoffeeMachineProductBrandBean.brandCodeItems = brandCodeItems;
	}
	
	public ExistKitchenApplianceCoffeeMachineProductBrandBean() {
