...
public class ExistKitchenApplianceRiceCookerProductBrandBean {
	...
	public ExistKitchenApplianceRiceCookerProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.KITCHEN_APPLIANCE_RICE_COOKER_NAME, subMenu);
		try {
