...
public class ExistHealthDeviceElectronicSphygmomanometerProductBrandBean {
	...
	public ExistHealthDeviceElectronicSphygmomanometerProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HEALTH_DEVICE_ELECTRONIC_SPHYGMOMANOMETER_NAME, subMenu);
		try {
