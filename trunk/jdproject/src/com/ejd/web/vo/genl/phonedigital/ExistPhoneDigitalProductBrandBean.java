...
public class ExistPhoneDigitalProductBrandBean {
	...
	public ExistPhoneDigitalProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PHONE_DIGITAL_NAME, subMenu);
		try {
