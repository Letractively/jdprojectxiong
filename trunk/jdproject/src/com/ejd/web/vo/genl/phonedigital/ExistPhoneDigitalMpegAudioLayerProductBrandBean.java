...
public class ExistPhoneDigitalMpegAudioLayerProductBrandBean {
	...
	public ExistPhoneDigitalMpegAudioLayerProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PHONE_DIGITAL_MPEG_AUDIO_LAYER_NAME, subMenu);
		try {
