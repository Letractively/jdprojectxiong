...
public class ExistHouseholdAppliancePeelingMachineProductBrandBean {
	...
	public ExistHouseholdAppliancePeelingMachineProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_PEELING_MACHINE_NAME, subMenu);
		try {
