...
public class ExistKitchenApplianceElectricStewPanProductBrandBean {
	...
	public ExistKitchenApplianceElectricStewPanProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.KITCHEN_APPLIANCE_ELECTRIC_STEW_PAN_NAME, subMenu);
		try {
