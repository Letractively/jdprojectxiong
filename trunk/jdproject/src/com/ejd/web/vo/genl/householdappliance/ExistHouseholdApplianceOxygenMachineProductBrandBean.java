...
public class ExistHouseholdApplianceOxygenMachineProductBrandBean {
	...
	public ExistHouseholdApplianceOxygenMachineProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_OXYGEN_MACHINE_NAME, subMenu);
		try {
