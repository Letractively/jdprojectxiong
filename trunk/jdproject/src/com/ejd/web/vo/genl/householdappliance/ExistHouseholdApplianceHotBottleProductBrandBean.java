...
public class ExistHouseholdApplianceHotBottleProductBrandBean {
	...
	public ExistHouseholdApplianceHotBottleProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_HOTBOTTLE_NAME, subMenu);
		try {
