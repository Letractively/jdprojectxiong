...
public class ExistPersonalCareFittingsProductBrandBean {
	...
	public ExistPersonalCareFittingsProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PERSONAL_CARE_FITTINGS_NAME, subMenu);
		try {
