...
public class ExistPersonalCareFitnessEquipmentProductBrandBean {
	...
	public ExistPersonalCareFitnessEquipmentProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PERSONAL_CARE_FITNESSEQUIPMENT_NAME, subMenu);
		try {
