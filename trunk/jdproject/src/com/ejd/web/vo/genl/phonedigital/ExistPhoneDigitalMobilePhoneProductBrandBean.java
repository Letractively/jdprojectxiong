...
public class ExistPhoneDigitalMobilePhoneProductBrandBean {
	...
	public ExistPhoneDigitalMobilePhoneProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PHONE_DIGITAL_MOBILE_PHONE_NAME, subMenu);
		try {
