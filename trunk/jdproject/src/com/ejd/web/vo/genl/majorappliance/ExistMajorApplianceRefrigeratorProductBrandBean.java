...
public class ExistMajorApplianceRefrigeratorProductBrandBean {
	...
	public ExistMajorApplianceRefrigeratorProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.MAJOR_APPLIANCE_REFRIGERATOR_NAME, subMenu);
		try {
