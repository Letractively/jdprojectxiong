...
public class ExistPersonalCareSkinCareProductBrandBean {
	...
	public ExistPersonalCareSkinCareProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PERSONAL_CARE_SKINCARE_NAME, subMenu);
		try {
