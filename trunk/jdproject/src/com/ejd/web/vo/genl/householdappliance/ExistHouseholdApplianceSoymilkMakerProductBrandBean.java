...
public class ExistHouseholdApplianceSoymilkMakerProductBrandBean {
	...
	public ExistHouseholdApplianceSoymilkMakerProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_SOYMILKMAKER_NAME, subMenu);
		try {
