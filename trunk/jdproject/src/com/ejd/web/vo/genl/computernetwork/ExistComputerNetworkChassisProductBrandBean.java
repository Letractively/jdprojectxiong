...
public class ExistComputerNetworkChassisProductBrandBean {
	...
	public ExistComputerNetworkChassisProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.COMPUTER_NETWORK_CHASSIS_NAME, subMenu);
		try {
