package com.ejd.web.vo.genl.computernetwork;
...
public class ExistComputerNetworkKeyboardAndMousePackageProductBrandBean {
	...
	public ExistComputerNetworkKeyboardAndMousePackageProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.COMPUTER_NETWORK_KEYBOARDANDMOUSEPACKAGE_NAME, subMenu);
		try {
