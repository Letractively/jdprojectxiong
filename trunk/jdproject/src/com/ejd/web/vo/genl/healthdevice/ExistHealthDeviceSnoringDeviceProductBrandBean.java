...
public class ExistHealthDeviceSnoringDeviceProductBrandBean {
	...
	public ExistHealthDeviceSnoringDeviceProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HEALTH_DEVICE_SNORING_DEVICE_NAME, subMenu);
		try {
