...
public class ExistPersonalCareShaverProductBrandBean {
	...
	public ExistPersonalCareShaverProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PERSONAL_CARE_SHAVER_NAME, subMenu);
		try {
