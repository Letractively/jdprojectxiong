...
public class ExistComputerNetworkWebcamProductBrandBean {
	...
	public ExistComputerNetworkWebcamProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.COMPUTER_NETWORK_WEBCAM_NAME, subMenu);
		try {
