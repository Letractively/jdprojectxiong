...
public class ExistComputerNetworkProductBrandBean {
	...
	public ExistComputerNetworkProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.COMPUTER_NETWORK_NAME, subMenu);
		try {
