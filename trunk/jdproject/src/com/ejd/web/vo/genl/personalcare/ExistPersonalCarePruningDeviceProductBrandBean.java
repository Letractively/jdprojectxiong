...
public class ExistPersonalCarePruningDeviceProductBrandBean {
	...
	public ExistPersonalCarePruningDeviceProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PERSONAL_CARE_PRUNINGDEVICE_NAME, subMenu);
		try {
