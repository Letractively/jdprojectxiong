...
public class ExistPhoneDigitalFittingProductBrandBean {
	...
	public ExistPhoneDigitalFittingProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PHONE_DIGITAL_DIGITALFITTING_NAME, subMenu);
		try {
