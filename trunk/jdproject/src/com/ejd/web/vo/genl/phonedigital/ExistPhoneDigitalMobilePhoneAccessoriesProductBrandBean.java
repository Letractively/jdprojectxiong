...
public class ExistPhoneDigitalMobilePhoneAccessoriesProductBrandBean {
	...
	public ExistPhoneDigitalMobilePhoneAccessoriesProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PHONE_DIGITAL_MOBILE_PHONE_ACCESSORIES_NAME, subMenu);
		try {
