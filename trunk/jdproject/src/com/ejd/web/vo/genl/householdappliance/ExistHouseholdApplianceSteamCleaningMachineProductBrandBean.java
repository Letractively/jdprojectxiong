...
public class ExistHouseholdApplianceSteamCleaningMachineProductBrandBean {
	...
	public ExistHouseholdApplianceSteamCleaningMachineProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_STEAM_CLEANING_MACHINE_NAME, subMenu);
		try {
