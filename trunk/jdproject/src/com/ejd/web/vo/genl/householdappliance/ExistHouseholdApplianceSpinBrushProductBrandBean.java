...
public class ExistHouseholdApplianceSpinBrushProductBrandBean {
	...
	public ExistHouseholdApplianceSpinBrushProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_SPINBRUSH_NAME, subMenu);
		try {
