...
public class ExistKitchenApplianceVentilatorProductBrandBean {
	...
	public ExistKitchenApplianceVentilatorProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.KITCHEN_APPLIANCE_VENTILATOR_NAME, subMenu);
		try {
