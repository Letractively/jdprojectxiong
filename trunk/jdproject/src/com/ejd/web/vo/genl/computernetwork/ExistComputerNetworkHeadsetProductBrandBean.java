...
public class ExistComputerNetworkHeadsetProductBrandBean {
	...
	public ExistComputerNetworkHeadsetProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.COMPUTER_NETWORK_HEADSET_NAME, subMenu);
		try {
