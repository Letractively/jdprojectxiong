...
public class ExistHouseholdAppliancePurifiedWaterProductBrandBean {
	...
	public static void setBrandCodeItems(SelectItem[] brandCodeItems) {
		ExistHouseholdAppliancePurifiedWaterProductBrandBean.brandCodeItems = brandCodeItems;
	}
	
	public ExistHouseholdAppliancePurifiedWaterProductBrandBean() {
