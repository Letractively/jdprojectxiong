...
public class ExistHouseholdApplianceLinkedTohotSteamMachineProductBrandBean {
	...
	public ExistHouseholdApplianceLinkedTohotSteamMachineProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_LINKED_TOHOT_STEAM_MACHINE_NAME, subMenu);
		try {
