...
public class ExistComputerNetworkPcSharingDeviceProductBrandBean {
	...
	public ExistComputerNetworkPcSharingDeviceProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.COMPUTER_NETWORK_PC_SHARING_DEVICE_NAME, subMenu);
		try {
