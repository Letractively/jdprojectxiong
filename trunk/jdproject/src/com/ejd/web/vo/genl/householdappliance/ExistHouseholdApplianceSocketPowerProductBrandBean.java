...
public class ExistHouseholdApplianceSocketPowerProductBrandBean {
	...
	public ExistHouseholdApplianceSocketPowerProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_SOCKETPOWER_NAME, subMenu);
		try {
