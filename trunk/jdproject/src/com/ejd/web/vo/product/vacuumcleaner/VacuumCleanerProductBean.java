...
public class VacuumCleanerProductBean extends PagedBaseBean {
	...
	private String powerSupplyTypeItems;
	private String powerSupplyTypeItemsLabel;
	private String useTypeItems;
	private String useTypeItemsLabel;
	...
	public VacuumCleanerProductBean() {
		super();
		this.primaryCategoryLabel = "";
		this.secondCategoryLabel = "";
		this.brandLabel = "全部";
		this.priceRangeLabel = "全部";
		this.powerSupplyTypeItemsLabel = "全部";
		this.useTypeItemsLabel = "全部";
		this.styleImgFont = "";
		this.styleFont = "";
		this.styleImg = "_on";
		this.number10 = "_on";
		...
		this.primaryCategoryCode = HeaderConstants.HOUSEHOLD_APPLIANCE_ID;
		this.secondCategoryCode = HeaderConstants.subMenu04;
		this.setBrandCode("");
		this.setPriceRange(null);
		this.setPowerSupplyTypeItems("");
		this.setUseTypeItems("");
	}
	public int getTotalCount() {
		int totalCount = 0;
		List alist= new ArrayList();
		try {
			alist = this.getProductService().getPSBPF1F2F3F4F5F6F7F8F9F10ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, null, null, null, null, null, powerSupplyTypeItems, useTypeItems, null, null, null);
	...
	public DataPage<Product> getDataPage(int startRow, int pageSize) {
		...
		try {
			dataPage = new DataPage<Product>(getTotalCount(), startRow,this.getProductService().getPSBPF1F2F3F4F5F6F7F8F9F10ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, null, null, null, null, null, powerSupplyTypeItems, useTypeItems, null, null, null));
		} catch (ProductException e) {
			e.printStackTrace();
		}
		return dataPage;
	...
	public String getPowerSupplyTypeItems() {
		return powerSupplyTypeItems;
	}
	public void setPowerSupplyTypeItems(String powerSupplyTypeItems) {
		this.powerSupplyTypeItems = powerSupplyTypeItems;
	}
	public String getPowerSupplyTypeItemsLabel() {
		return powerSupplyTypeItemsLabel;
	}
	public void setPowerSupplyTypeItemsLabel(String powerSupplyTypeItemsLabel) {
		this.powerSupplyTypeItemsLabel = powerSupplyTypeItemsLabel;
	}
	public String getUseTypeItems() {
		return useTypeItems;
	}
	public void setUseTypeItems(String useTypeItems) {
		this.useTypeItems = useTypeItems;
	}
	public String getUseTypeItemsLabel() {
		return useTypeItemsLabel;
	}
	public void setUseTypeItemsLabel(String useTypeItemsLabel) {
		this.useTypeItemsLabel = useTypeItemsLabel;
	}
