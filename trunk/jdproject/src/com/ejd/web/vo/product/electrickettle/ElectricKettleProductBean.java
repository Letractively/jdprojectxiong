...
public class ElectricKettleProductBean extends PagedBaseBean {
	...
	private String materialTypeItems;
	private String materialTypeItemsLabel;
	...
	public ElectricKettleProductBean() {
		super();
		...
		this.materialTypeItemsLabel = "全部";
		this.styleImgFont = "";
		this.styleFont = "";
		this.styleImg = "_on";
		this.number10 = "_on";
		...
		this.setMaterialTypeItems("");
	}
	public int getTotalCount() {
		int totalCount = 0;
		List alist= new ArrayList();
		try {
			alist = this.getProductService().getPSBPF1F2F3F4F5F6F7F8F9F10ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, volumeRange, null, null,null,null, materialTypeItems,null,null,null,null);
	...
	public DataPage<Product> getDataPage(int startRow, int pageSize) {
		...
		try {
			dataPage = new DataPage<Product>(getTotalCount(), startRow,this.getProductService().getPSBPF1F2F3F4F5F6F7F8F9F10ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, volumeRange, null, null,null,null, materialTypeItems,null,null,null,null));
		} catch (ProductException e) {
			e.printStackTrace();
		}
		return dataPage;
	...
	public String getMaterialTypeItems() {
		return materialTypeItems;
	}
	public void setMaterialTypeItems(String materialTypeItems) {
		this.materialTypeItems = materialTypeItems;
	}
	public String getMaterialTypeItemsLabel() {
		return materialTypeItemsLabel;
	}
	public void setMaterialTypeItemsLabel(String materialTypeItemsLabel) {
		this.materialTypeItemsLabel = materialTypeItemsLabel;
	}
