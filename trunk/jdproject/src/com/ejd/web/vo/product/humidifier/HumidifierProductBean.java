...
public class HumidifierProductBean extends PagedBaseBean {
	...
	public int getTotalCount() {
		...
		try {
			alist = this.getProductService().getPSBPF1F2F3F4F5F6F7F8F9F10ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, volumeRange, null, null,null,null, useTypeItems,null,null,null,null);
	...
	public DataPage<Product> getDataPage(int startRow, int pageSize) {
		...
		try {
			dataPage = new DataPage<Product>(getTotalCount(), startRow,this.getProductService().getPSBPF1F2F3F4F5F6F7F8F9F10ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, volumeRange, null, null,null,null, useTypeItems,null,null,null,null));
		} catch (ProductException e) {
			e.printStackTrace();
		}
		return dataPage;
