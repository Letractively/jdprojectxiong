...
public class FoodProcessingMachineProductBean extends PagedBaseBean {
	...
	public FoodProcessingMachineProductBean() {
		super();
		...
		this.secondCategoryCode = HeaderConstants.subMenu23;
		this.setBrandCode("");
