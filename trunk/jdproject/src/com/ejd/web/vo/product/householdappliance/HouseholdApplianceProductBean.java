...
public class HouseholdApplianceProductBean extends PagedBaseBean {
	...
	public HouseholdApplianceProductBean() {
		super();
		...
		this.setBrandCode("");
		this.setSecondCategoryCode(null);
		this.setPriceRange(null);
		this.setProductType(HeaderConstants.HOUSEHOLD_APPLIANCE_ID);
	}
