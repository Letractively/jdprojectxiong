...
public class ElectricFanProductBean extends PagedBaseBean {
	...
	private RangeParam gearsRange;
	private String gearsRangeLabel;
	...
	public ElectricFanProductBean() {
		super();
		this.primaryCategoryLabel = "";
		this.secondCategoryLabel = "";
		this.brandLabel = "全部";
		this.priceRangeLabel = "全部";
		this.setPowerRangeLabel("全部");
		this.gearsRangeLabel = "全部";
	...
	public int getTotalCount() {
		...
		try {
			alist = this.getProductService().getPSBPF1F2F3F4F5F6F7F8F9F10ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, powerRange, gearsRange, null, null, null, setTypeItems, null, null, null, null );
	...
	public DataPage<Product> getDataPage(int startRow, int pageSize) {
		...
		try {
			dataPage = new DataPage<Product>(getTotalCount(), startRow,this.getProductService().getPSBPF1F2F3F4F5F6F7F8F9F10ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, powerRange, gearsRange, null, null, null, setTypeItems, null, null, null, null));
		} catch (ProductException e) {
			e.printStackTrace();
		}
		return dataPage;
	...
	public RangeParam getGearsRange() {
		return gearsRange;
	}
	public void setGearsRange(RangeParam gearsRange) {
		this.gearsRange = gearsRange;
	}
	public String getGearsRangeLabel() {
		return gearsRangeLabel;
	}
	public void setGearsRangeLabel(String gearsRangeLabel) {
		this.gearsRangeLabel = gearsRangeLabel;
	}
