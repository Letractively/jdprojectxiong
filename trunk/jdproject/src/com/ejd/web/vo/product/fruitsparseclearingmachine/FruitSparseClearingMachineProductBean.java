...
public class FruitSparseClearingMachineProductBean extends PagedBaseBean {
	...
	public FruitSparseClearingMachineProductBean() {
		super();
		...
		this.secondCategoryCode = HeaderConstants.subMenu22;
		this.setBrandCode("");
