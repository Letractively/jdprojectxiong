...
public class DisinfectionCabinetProductBean extends PagedBaseBean {
	...
	public DisinfectionCabinetProductBean() {
		super();
		...
		this.secondCategoryCode = HeaderConstants.subMenu15;
		this.setBrandCode("");
	...
	public int getTotalCount() {
		...
		try {
			alist = this.getProductService().getPSBPF1F2F6ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, volumeRange, powerRange, typeItems);
	...
	public DataPage<Product> getDataPage(int startRow, int pageSize) {
		...
		try {
			dataPage = new DataPage<Product>(getTotalCount(), startRow,this.getProductService().getPSBPF1F2F6ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, volumeRange, powerRange, typeItems));
		} catch (ProductException e) {
			e.printStackTrace();
		}
		return dataPage;
	...
	public String getTypeItemsLabel() {
		return typeItemsLabel;
	}
	public void setTypeItemsLabel(String typeItemsLabel) {
		this.typeItemsLabel = typeItemsLabel;
	}
