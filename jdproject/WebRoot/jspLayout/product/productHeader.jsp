...
<h:form id="headerMainform"> 
				<rich:tabPanel valueChangeListener="#{headerTabPanel.valueChanged}" headerSpacing="0px" immediate="false" tabClass="tabClass" activeTabClass="italic" width="100%" switchType="ajax" binding="#{headerTabPanel.tabPanel}" selectedTab="#{headerTabPanel.currentTab}" id="tab_panel" headerAlignment="left" height="50px;">
