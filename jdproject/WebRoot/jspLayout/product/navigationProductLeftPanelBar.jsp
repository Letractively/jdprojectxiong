...
<f:subview id="allProductLeftView">
	<h:form id="allProductLeftViewForm">
		...
		<rich:panel headerClass="left-navigation-product-header" styleClass="panel-none-border" bodyClass="left-navigation-product-body">
			<f:facet name="header"><h:outputLabel value="商品分类"/></f:facet>
			<rich:panelBar id="kitchenApplianceLeftPb" selectedPanel="#{productPanelBar.currentBar}" style="width:#{msgs['template.product.left.widthpx']}"  styleClass="panel-bar-product-left" contentStyle="BACKGROUND-COLOR: #FFFFFF">
