...
<html>
    ...
    <body>
    	<ui:composition template="../productTemplate.jsp">
    		<ui:define id="inductionCookerLeft" name="left">
    			<ui:include id="inductionCookerLeftInclude" src="../navigationProductLeft.jsp">
			...
			<ui:define id="inductionCookerContent" name="content">
    			...
    			<a4j:region id="inductionCookerContentRegionStyle" renderRegionOnly="false" selfRendered="true">
    				<h:form id="inductionCookerContentRegionStyleForm">
    					<rich:panel id="inductionCookerContentRegionStyleFormPanel" styleClass="operate-show-style">
							...
							<h:panelGroup>
									...
									<a4j:commandLink id="number15button" reRender="inductionCookerContentRegionStyleFormPanel,productList">
										...
										<a4j:actionparam name="numberOnePage" value="15" assignTo="#{listInductionCookerProduct.numberOnePage}"></a4j:actionparam>
								    </a4j:commandLink>
									<a4j:commandLink id="number30button" reRender="inductionCookerContentRegionStyleFormPanel,productList">
										...
										<a4j:actionparam name="number40" value="" assignTo="#{listInductionCookerProduct.number40}"></a4j:actionparam>
										<a4j:actionparam name="number100" value="" assignTo="#{listInductionCookerProduct.number100}"></a4j:actionparam>
										<a4j:actionparam name="numberOnePage" value="30" assignTo="#{listInductionCookerProduct.numberOnePage}"></a4j:actionparam>
								    </a4j:commandLink>
									<a4j:commandLink id="number60button" reRender="inductionCookerContentRegionStyleFormPanel,productList">
										...
										<a4j:actionparam name="number100" value="" assignTo="#{listInductionCookerProduct.number100}"></a4j:actionparam>
										<a4j:actionparam name="numberOnePage" value="45" assignTo="#{listInductionCookerProduct.numberOnePage}"></a4j:actionparam>
								    </a4j:commandLink>
									<a4j:commandLink id="number90button" reRender="inductionCookerContentRegionStyleFormPanel,productList">
										...
										<a4j:actionparam name="numberOnePage" value="90" assignTo="#{listInductionCookerProduct.numberOnePage}"></a4j:actionparam>
								    </a4j:commandLink>
    			...
    			<h:outputText value="抱歉，找不到符合条件的商品!" rendered="#{(null != listInductionCookerProduct.dataModel) and (listInductionCookerProduct.dataModel.rowCount le 0)}" styleClass="no-product-find"></h:outputText>
    			<rich:dataGrid id="productListImg" rendered="#{listInductionCookerProduct.styleImgFlag}" headerClass="table-list-product-panel-grid-header" footerClass="table-list-product-panel-grid-footer" width="100%" columns="3" elements="#{listInductionCookerProduct.numberOnePage}" cellspacing="0" cellpadding="10" first="1" columnClasses="table-list-product-panel-grid-column" value="#{listInductionCookerProduct.dataModel}" var="product" rowKeyVar="rowIndex" frame="void" border="0" align="center" styleClass="table-list-product-panel-grid-data-grid">            
                <f:facet name="header">
                	<h:outputText value="产品列表(共有:#{listInductionCookerProduct.dataModel.rowCount}件商品)" rendered="#{listInductionCookerProduct.dataModel.rowCount>0}"></h:outputText>
      			</f:facet>
