    ...
    <body>
    	<ui:composition template="../productTemplate.jsp">
			...
			<ui:define id="riceCookerContent" name="content">
    			...
    			<rich:panelBar id="riceCookerpb" styleClass="panel-none-border" headerClass="panel-header-none-border" style="width:#{msgs['template.product.content.widthpx']};border-style:none;" contentStyle="panel-documents-none-border">
    					...
    					<rich:panel id="riceCookerContentRegionStyleFormPanel" styleClass="operate-show-style">
							...
							<h:panelGroup>
									...
									<a4j:commandLink id="number90button" reRender="riceCookerContentRegionStyleFormPanel,productList">
										...
										<a4j:actionparam name="numberOnePage" value="90" assignTo="#{listRiceCookerProduct.numberOnePage}"></a4j:actionparam>
								    </a4j:commandLink>
