...
<table width="100%">
	<tbody>
		...
		<td style="PADDING-LEFT: 8px;width:20%;text-align:left;">
			<h:outputLabel value="品牌:" styleClass="current-selected_label"></h:outputLabel><h:outputLabel id="brandLabel" styleClass="current-selected" value="#{listHouseholdApplianceProduct.brandLabel}"></h:outputLabel>
		</td>
			
				<td class="selected-new" width="80%">
					<a4j:repeat var="brand" rowKeyVar="index" value="#{brands}">
					<a4j:commandLink action="#{navigationHouseholdAppliance.clickLink}" ajaxSingle="true" style="CURSOR: pointer;" immediate="true" limitToList="true" reRender="productList,brandLabel,secondCategoryLabel">
		...
		<tr>
			<td style="PADDING-LEFT: 8px;width:20%;text-align:left;">
				<h:outputLabel value="类别:" styleClass="current-selected_label"></h:outputLabel><h:outputText id="secondCategoryLabel" styleClass="current-selected" value="#{listHouseholdApplianceProduct.secondCategoryLabel}"></h:outputText>
			</td>
			<td class="selected-new" width="80%">
