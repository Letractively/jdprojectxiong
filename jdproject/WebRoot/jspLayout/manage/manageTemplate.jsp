	...
	<h:form id="manageheaderform">
		<rich:toolBar id="tbar" width="100%" height="20px" itemSeparator="/css/images/icons/menu_separater.gif">
			...
			<rich:dropDownMenu id="dmtwo" value="产品管理" >
				<rich:menuItem id="dmtwomione" submitMode="ajax" value="上传产品图片" action="#{manageHeaderMenu.updateCurrent}" immediate="true">
                		<f:param name="current" value="addProductImage"/>
