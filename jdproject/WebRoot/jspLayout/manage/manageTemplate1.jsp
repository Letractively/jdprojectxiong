...
<h:panelGrid columns="3" style="width:100%" columnClasses="headerleftstyle,headermiddletstyle,headerrightstyle">
	<ui:insert name="manageNavigation">
		<f:subview id="manageNavigationView">
			<ui:include src="./manageLeftNavigation.jsp" />
		</f:subview>
	</ui:insert>
	...
	<ui:insert name="right">
		<f:subview id="manageRightView">
			<h:outputText value="dfafafafafafafafafaf"></h:outputText>
		</f:subview>
	</ui:insert>
