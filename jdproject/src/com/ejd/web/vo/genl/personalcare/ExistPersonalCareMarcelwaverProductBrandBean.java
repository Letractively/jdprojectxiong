...
public class ExistPersonalCareMarcelwaverProductBrandBean {
	...
	public ExistPersonalCareMarcelwaverProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PERSONAL_CARE_MARCELWAVER_NAME, subMenu);
		try {
