...
public class ExistPersonalCareProductBrandBean {
	...
	public ExistPersonalCareProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PERSONAL_CARE_NAME, subMenu);
		try {
