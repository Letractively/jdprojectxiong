...
public class ExistPersonalCareHairDryerProductBrandBean {
	...
	public ExistPersonalCareHairDryerProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PERSONAL_CARE_HAIR_DRYER_NAME, subMenu);
		try {
