...
public class ExistPersonalCareCurlEyeLashesBrowserProductBrandBean {
	...
	public ExistPersonalCareCurlEyeLashesBrowserProductBrandBean() {
		...
		List<MenuItem> subMenu = headerTabPanel.getPersonalCare().getSubMenu();
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PERSONAL_CARE_CURLEYELASHESBROWSER_NAME, subMenu);
		try {
