...
public class ExistPhoneDigitalRecorderPenProductBrandBean {
	...
	public ExistPhoneDigitalRecorderPenProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PHONE_DIGITAL_RECORDER_PEN_NAME, subMenu);
		try {
