package com.ejd.web.vo.genl.phonedigital;
...
public class ExistPhoneDigitalGlobalPositioningSystemProductBrandBean {
	...
	public ExistPhoneDigitalGlobalPositioningSystemProductBrandBean() {
		...
		List<MenuItem> subMenu = headerTabPanel.getPhoneDigital().getSubMenu();
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PHONE_DIGITAL_GLOBAL_POSITIONING_SYSTEM_NAME, subMenu);
		try {
