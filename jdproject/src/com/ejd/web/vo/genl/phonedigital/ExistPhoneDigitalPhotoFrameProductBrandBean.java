...
public class ExistPhoneDigitalPhotoFrameProductBrandBean {
	...
	public ExistPhoneDigitalPhotoFrameProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.PHONE_DIGITAL_DIGITAL_PHOTO_FRAME_NAME, subMenu);
		try {
