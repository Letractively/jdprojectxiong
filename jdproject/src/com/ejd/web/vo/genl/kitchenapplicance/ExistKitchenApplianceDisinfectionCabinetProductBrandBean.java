...
public class ExistKitchenApplianceDisinfectionCabinetProductBrandBean {
	...
	public ExistKitchenApplianceDisinfectionCabinetProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.KITCHEN_APPLIANCE_DISINFECTION_CABINET_NAME, subMenu);
		try {
