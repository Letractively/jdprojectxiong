...
public class ExistKitchenApplianceElectricSteamerProductBrandBean {
	...
	public ExistKitchenApplianceElectricSteamerProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.KITCHEN_APPLIANCE_ELECTRICSTEAMER_NAME, subMenu);
		try {
