...
public class ExistKitchenApplianceElectricWaterHeaterProductBrandBean {
	...
	public ExistKitchenApplianceElectricWaterHeaterProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.KITCHEN_APPLIANCE_ELECTRICWATERHEATER_NAME, subMenu);
		try {
