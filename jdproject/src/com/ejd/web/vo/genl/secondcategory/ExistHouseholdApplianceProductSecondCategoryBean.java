package com.ejd.web.vo.genl.secondcategory;
...
public class ExistHouseholdApplianceProductSecondCategoryBean {
	...
	public ExistHouseholdApplianceProductSecondCategoryBean() {
		if (null == this.getBeanName() || "".equals(this.getBeanName())) {
			this.setBeanName("householdAppliance");
		}
