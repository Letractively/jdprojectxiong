...
public class ExistMajorApplianceProductBrandBean {
	...
	public ExistMajorApplianceProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.MAJOR_APPLIANCE_NAME, subMenu);
		try {
