...
public class ExistMajorApplianceTvProductBrandBean {
	...
	public ExistMajorApplianceTvProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.MAJOR_APPLIANCE_TV_NAME, subMenu);
		try {
