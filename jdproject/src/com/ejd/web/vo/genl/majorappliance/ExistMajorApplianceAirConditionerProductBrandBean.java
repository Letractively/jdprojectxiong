...
public class ExistMajorApplianceAirConditionerProductBrandBean {
	...
	public ExistMajorApplianceAirConditionerProductBrandBean() {
		...
		List<MenuItem> subMenu = headerTabPanel.getMajorAppliance().getSubMenu();
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.MAJOR_APPLIANCE_AIR_CONDITIONER_NAME, subMenu);
		try {
