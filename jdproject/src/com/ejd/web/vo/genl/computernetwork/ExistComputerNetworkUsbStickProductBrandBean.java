...
public class ExistComputerNetworkUsbStickProductBrandBean {
	...
	public ExistComputerNetworkUsbStickProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.COMPUTER_NETWORK_USB_STICK_NAME, subMenu);
		try {
