...
public class ExistComputerNetworkAudioDeviceProductBrandBean {
	...
	public ExistComputerNetworkAudioDeviceProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.COMPUTER_NETWORK_AUDIO_DEVICE_NAME, subMenu);
		try {
