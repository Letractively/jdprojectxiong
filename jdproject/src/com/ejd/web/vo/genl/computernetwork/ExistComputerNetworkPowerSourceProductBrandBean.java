...
public class ExistComputerNetworkPowerSourceProductBrandBean {
	...
	public ExistComputerNetworkPowerSourceProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.COMPUTER_NETWORK_POWERSOURCE_NAME, subMenu);
		try {
