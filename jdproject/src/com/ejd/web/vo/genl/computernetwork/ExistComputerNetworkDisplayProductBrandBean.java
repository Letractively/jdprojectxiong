...
public class ExistComputerNetworkDisplayProductBrandBean {
	...
	public ExistComputerNetworkDisplayProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.COMPUTER_NETWORK_DISPLAY_NAME, subMenu);
		try {
