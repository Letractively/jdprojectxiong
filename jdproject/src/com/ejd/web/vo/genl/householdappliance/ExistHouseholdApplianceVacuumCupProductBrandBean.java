...
public class ExistHouseholdApplianceVacuumCupProductBrandBean {
	...
	public ExistHouseholdApplianceVacuumCupProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_VACUUM_CUP_NAME, subMenu);
		try {
