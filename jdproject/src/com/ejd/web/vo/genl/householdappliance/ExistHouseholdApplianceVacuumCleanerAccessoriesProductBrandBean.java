...
public class ExistHouseholdApplianceVacuumCleanerAccessoriesProductBrandBean {
	...
	public ExistHouseholdApplianceVacuumCleanerAccessoriesProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_VACUUMCLEANERACCESSORIES_NAME, subMenu);
		try {
