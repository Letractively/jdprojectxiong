...
public class ExistHouseholdApplianceTelephoneProductBrandBean {
	...
	public ExistHouseholdApplianceTelephoneProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_TELEPHONE_NAME, subMenu);
		try {
