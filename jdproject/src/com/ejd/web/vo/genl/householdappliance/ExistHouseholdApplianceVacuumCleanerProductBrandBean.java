...
public class ExistHouseholdApplianceVacuumCleanerProductBrandBean {
	...
	public ExistHouseholdApplianceVacuumCleanerProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_VACUUM_CLEANER_NAME, subMenu);
		try {
