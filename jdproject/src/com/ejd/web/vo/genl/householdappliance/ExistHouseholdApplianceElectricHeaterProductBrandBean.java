...
public class ExistHouseholdApplianceElectricHeaterProductBrandBean {
	...
	public ExistHouseholdApplianceElectricHeaterProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_ELECTRIC_HEATER_NAME, subMenu);
		try {
