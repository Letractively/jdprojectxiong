...
public class ExistHouseholdApplianceElectricToothBrushProductBrandBean {
	...
	public ExistHouseholdApplianceElectricToothBrushProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_ELECTRIC_TOOTHBRUSH_NAME, subMenu);
		try {
