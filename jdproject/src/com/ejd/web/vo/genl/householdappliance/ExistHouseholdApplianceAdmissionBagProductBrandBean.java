...
public class ExistHouseholdApplianceAdmissionBagProductBrandBean {
	...
	public ExistHouseholdApplianceAdmissionBagProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_ADMISSIONBAG_NAME, subMenu);
		try {
