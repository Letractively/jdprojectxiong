...
public class ExistHouseholdApplianceHumidifierProductBrandBean {
	...
	public ExistHouseholdApplianceHumidifierProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_HUMIDIFIER_NAME, subMenu);
		try {
