...
public class ExistHouseholdApplianceMosquitoSmokeMachineProductBrandBean {
	...
	public ExistHouseholdApplianceMosquitoSmokeMachineProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_MOSQUITOSMOKE_MACHINE_NAME, subMenu);
		try {
