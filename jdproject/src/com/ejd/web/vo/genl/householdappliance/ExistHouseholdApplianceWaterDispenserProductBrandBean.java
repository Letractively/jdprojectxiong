...
public class ExistHouseholdApplianceWaterDispenserProductBrandBean {
	...
	public ExistHouseholdApplianceWaterDispenserProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_WATER_DISPENSER_NAME, subMenu);
		try {
