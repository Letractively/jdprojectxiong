...
public class ExistHouseholdApplianceSteamMopProductBrandBean {
	...
	public ExistHouseholdApplianceSteamMopProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_STEAMMOP_NAME, subMenu);
		try {
