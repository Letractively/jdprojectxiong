...
public class ExistHouseholdApplianceProductBrandBean {
	...
	public ExistHouseholdApplianceProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_NAME, subMenu);
		try {
