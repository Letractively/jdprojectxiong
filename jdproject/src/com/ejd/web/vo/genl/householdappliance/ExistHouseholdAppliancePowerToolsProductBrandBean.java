...
public class ExistHouseholdAppliancePowerToolsProductBrandBean {
	...
	public ExistHouseholdAppliancePowerToolsProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HOUSEHOLD_APPLIANCE_POWERTOOLS_NAME, subMenu);
		try {
