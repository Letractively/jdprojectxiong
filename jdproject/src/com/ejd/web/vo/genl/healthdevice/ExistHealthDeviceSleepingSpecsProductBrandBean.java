...
public class ExistHealthDeviceSleepingSpecsProductBrandBean {
	...
	public ExistHealthDeviceSleepingSpecsProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HEALTH_DEVICE_SLEEPING_SPECS_NAME, subMenu);
		try {
