...
public class ExistHealthDeviceProductBrandBean {
	...
	public ExistHealthDeviceProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HEALTH_DEVICE_NAME, subMenu);
		try {
