...
public class ExistHealthDeviceElectronicWeigherProductBrandBean {
	...
	public ExistHealthDeviceElectronicWeigherProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HEALTH_DEVICE_ELECTRONIC_WEIGHER_NAME, subMenu);
		try {
