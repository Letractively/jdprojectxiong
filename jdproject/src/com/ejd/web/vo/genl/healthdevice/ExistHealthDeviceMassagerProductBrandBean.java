...
public class ExistHealthDeviceMassagerProductBrandBean {
	...
	public ExistHealthDeviceMassagerProductBrandBean() {
		...
		MenuItem paraItem = HeaderMenuUtil.getMenuItemByName(HeaderConstants.HEALTH_DEVICE_MASSAGER_NAME, subMenu);
		try {
