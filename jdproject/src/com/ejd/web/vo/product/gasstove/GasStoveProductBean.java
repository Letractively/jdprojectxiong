...
public class GasStoveProductBean extends PagedBaseBean {
	...
	private RangeParam numberRange;
	private String numberRangeLabel;
	private String gasType;
	private String gasTypeLabel;
	private String fitType;
	private String fitTypeLabel;
	...
	public int getTotalCount() {
		...
		try {
			alist = this.getProductService().getPSBPF1F6F7ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, numberRange,gasType,fitType);
	...
	public DataPage<Product> getDataPage(int startRow, int pageSize) {
		...
		try {
			dataPage = new DataPage<Product>(getTotalCount(), startRow,this.getProductService().getPSBPF1F6F7ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, numberRange,gasType,fitType));
		} catch (ProductException e) {
			e.printStackTrace();
		}
		return dataPage;
	...
	public RangeParam getNumberRange() {
		return numberRange;
	}
	public void setNumberRange(RangeParam numberRange) {
		this.numberRange = numberRange;
	}
	public String getNumberRangeLabel() {
		return numberRangeLabel;
	}
	public void setNumberRangeLabel(String numberRangeLabel) {
		this.numberRangeLabel = numberRangeLabel;
	}
	...
	public String getFitTypeLabel() {
		return fitTypeLabel;
	}
	public void setFitTypeLabel(String fitTypeLabel) {
		this.fitTypeLabel = fitTypeLabel;
	}
