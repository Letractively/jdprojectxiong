...
public class VentilatorProductBean extends PagedBaseBean {
	...
	private RangeParam windRange;
	private String windRangeLabel;
	...
	public VentilatorProductBean() {
		...
		this.secondCategoryCode = HeaderConstants.subMenu27;
		this.setBrandCode("");
		this.setPriceRange(null);
		this.setWindRange(null);
	...
	public int getTotalCount() {
		...
		try {
			alist = this.getProductService().getPSBPF1F2ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, windRange, powerRange);
	...
	public DataPage<Product> getDataPage(int startRow, int pageSize) {
		...
		try {
			dataPage = new DataPage<Product>(getTotalCount(), startRow,this.getProductService().getPSBPF1F2ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, windRange, powerRange));
		} catch (ProductException e) {
			e.printStackTrace();
		}
		return dataPage;
	...
	public RangeParam getWindRange() {
		return windRange;
	}
	public void setWindRange(RangeParam windRange) {
		this.windRange = windRange;
	}
	public String getWindRangeLabel() {
		return windRangeLabel;
	}
	public void setWindRangeLabel(String windRangeLabel) {
		this.windRangeLabel = windRangeLabel;
	}
