...
public class InductionCookerProductBean extends PagedBaseBean {
	...
	public int getTotalCount() {
		...
		try {
			alist = this.getProductService().getInductionCookerProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, panelType, fitting);
	...
	public DataPage<Product> getDataPage(int startRow, int pageSize) {
		...
		try {
			dataPage = new DataPage<Product>(getTotalCount(), startRow,this.getProductService().getInductionCookerProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, panelType, fitting));
		} catch (ProductException e) {
			e.printStackTrace();
		}
		return dataPage;
