...
public class GasWaterHeaterProductBean extends PagedBaseBean {
	...
	private RangeParam yieldRange;
	private String yieldRangeLabel;
	private String gasType;
	private String gasTypeLabel;
	private String smokeType;
	private String smokeTypeLabel;
	...
	public GasWaterHeaterProductBean() {
		this.primaryCategoryLabel = "";
		this.secondCategoryLabel = "";
		this.brandLabel = "全部";
		this.priceRangeLabel = "全部";
		this.volumeRangeLabel = "全部";
		this.yieldRangeLabel = "全部";
		this.gasTypeLabel = "全部";
		this.smokeTypeLabel = "全部";
		this.styleImgFont = "";
		this.styleFont = "";
		this.styleImg = "_on";
		this.number10 = "_on";
		...
		this.secondCategoryCode = HeaderConstants.subMenu21;
		this.setBrandCode("");
		this.setPriceRange(null);
		this.setVolumeRange(null);
		this.setYieldRange(null);
		this.setGasType("");
		this.setSmokeType("");
	}
	public int getTotalCount() {
		...
		try {
			alist = this.getProductService().getPSBPF1F2F6F7ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, volumeRange, yieldRange, gasType,smokeType);
	...
	public DataPage<Product> getDataPage(int startRow, int pageSize) {
		...
		try {
			dataPage = new DataPage<Product>(getTotalCount(), startRow,this.getProductService().getPSBPF1F2F6F7ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, volumeRange, yieldRange, gasType,smokeType));
		} catch (ProductException e) {
			e.printStackTrace();
		}
		return dataPage;
	...
	public RangeParam getYieldRange() {
		return yieldRange;
	}
	public void setYieldRange(RangeParam yieldRange) {
		this.yieldRange = yieldRange;
	}
	public String getYieldRangeLabel() {
		return yieldRangeLabel;
	}
	public void setYieldRangeLabel(String yieldRangeLabel) {
		this.yieldRangeLabel = yieldRangeLabel;
	}
	...
	public String getGasTypeLabel() {
		return gasTypeLabel;
	}
	public void setGasTypeLabel(String gasTypeLabel) {
		this.gasTypeLabel = gasTypeLabel;
	}
	...
	public String getSmokeTypeLabel() {
		return smokeTypeLabel;
	}
	public void setSmokeTypeLabel(String smokeTypeLabel) {
		this.smokeTypeLabel = smokeTypeLabel;
	}
