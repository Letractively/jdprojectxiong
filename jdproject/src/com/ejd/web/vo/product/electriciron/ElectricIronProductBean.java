...
public class ElectricIronProductBean extends PagedBaseBean {
	...
	private String steamTypeItems;
	private String steamTypeItemsLabel;
	...
	public ElectricIronProductBean() {
		...
		this.setSteamTypeItems("");
	}
	public int getTotalCount() {
		int totalCount = 0;
		List alist= new ArrayList();
		try {
			alist = this.getProductService().getPSBPF1F2F3F4F5F6F7F8F9F10ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, null, null, null, null, null, steamTypeItems, null, null, null, null );
	...
	public DataPage<Product> getDataPage(int startRow, int pageSize) {
		...
		try {
			dataPage = new DataPage<Product>(getTotalCount(), startRow,this.getProductService().getPSBPF1F2F3F4F5F6F7F8F9F10ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, null, null, null, null, null, steamTypeItems, null, null, null, null));
		} catch (ProductException e) {
			e.printStackTrace();
		}
		return dataPage;
	...
	public String getSteamTypeItems() {
		return steamTypeItems;
	}
	public void setSteamTypeItems(String steamTypeItems) {
		this.steamTypeItems = steamTypeItems;
	}
	public String getSteamTypeItemsLabel() {
		return steamTypeItemsLabel;
	}
	public void setSteamTypeItemsLabel(String steamTypeItemsLabel) {
		this.steamTypeItemsLabel = steamTypeItemsLabel;
	}
