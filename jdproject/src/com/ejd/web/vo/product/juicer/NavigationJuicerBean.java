package com.ejd.web.vo.product.juicer;
...
import com.ejd.web.vo.genl.kitchenapplicance.ExistKitchenApplianceJuicerProductBrandBean;
...
public class NavigationJuicerBean {
	...
	public NavigationJuicerBean () {
		ExistKitchenApplianceJuicerProductBrandBean existKitchenApplianceJuicerProductBrand = (ExistKitchenApplianceJuicerProductBrandBean) SpringFacesUtil.getManagedBean(ManageBeanConstants.EXIST_KITCHEN_APPLIANCE_JUICER_PRODUCT_BRAND_BEAN_NAME);
		SelectItem[] result = null;
		result = existKitchenApplianceJuicerProductBrand.getBrandCodeItems();
...
public String clickLink() {
		...
		JuicerProductBean listJuicerProduct = (JuicerProductBean) SpringFacesUtil.getManagedBean(ManageBeanConstants.LIST_JUICER_PRODUCT_BEAN_NAME);
		listJuicerProduct.setDataModel(null);
		...
		if (null != brandLabel) {
			listJuicerProduct.setBrandLabel((String)brandLabel);
		}
		return null;
	}
