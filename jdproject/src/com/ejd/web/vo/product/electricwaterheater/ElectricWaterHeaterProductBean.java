...
public class ElectricWaterHeaterProductBean extends PagedBaseBean {
	...
	private RangeParam pressureRange;
	private String pressureRangeLabel;
	private String setTypeItems;
	private String setTypeItemsLabel;
	...
	public ElectricWaterHeaterProductBean() {
		super();
		...
		this.pressureRangeLabel="全部";
		this.powerRangeLabel="全部";
		this.setTypeItemsLabel = "全部";
		this.styleImgFont = "";
		this.styleFont = "";
		this.styleImg = "_on";
		this.number10 = "_on";
		...
		this.secondCategoryCode = HeaderConstants.subMenu26;
		this.setBrandCode("");
		this.setPriceRange(null);
		this.setVolumeRange(null);
		this.setPowerRange(null);
		this.setPressureRange(null);
	...
	public int getTotalCount() {
		...
		try {
			alist = this.getProductService().getPSBPF1F2F3F4F5F6F7F8F9F10ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, volumeRange, powerRange, pressureRange,null,null, setTypeItems,null,null,null,null);
	...
	public DataPage<Product> getDataPage(int startRow, int pageSize) {
		...
		try {
			dataPage = new DataPage<Product>(getTotalCount(), startRow,this.getProductService().getPSBPF1F2F3F4F5F6F7F8F9F10ProductByCriteria(primaryCategoryCode, secondCategoryCode, brandCode, priceRange, volumeRange, powerRange, pressureRange,null,null, setTypeItems,null,null,null,null));
		} catch (ProductException e) {
			e.printStackTrace();
		}
		return dataPage;
	...
	public RangeParam getPressureRange() {
		return pressureRange;
	}
	public void setPressureRange(RangeParam pressureRange) {
		this.pressureRange = pressureRange;
	}
	public String getPressureRangeLabel() {
		return pressureRangeLabel;
	}
	public void setPressureRangeLabel(String pressureRangeLabel) {
		this.pressureRangeLabel = pressureRangeLabel;
	}
	
	public String getSetTypeItems() {
		return setTypeItems;
	}
	public void setSetTypeItems(String setTypeItems) {
		this.setTypeItems = setTypeItems;
	}
	public String getSetTypeItemsLabel() {
		return setTypeItemsLabel;
	}
	public void setSetTypeItemsLabel(String setTypeItemsLabel) {
		this.setTypeItemsLabel = setTypeItemsLabel;
	}
